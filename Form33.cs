...
namespace WindowsFormsApplication1
{
    public partial class Form33 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update Teacher_login set Teacher_status='Deactive' where Teacher_name='" + textBox1.Text + "'";
            cmd.ExecuteNonQuery();
            ...
            string Body = "Dear"+Form13.Teacher_uname+"you were removed by ADMIN"+"so, You cannot Login into E-Learning Application";
            mail.Body = Body;
